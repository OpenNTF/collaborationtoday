...
public class TwitterProfileImage {

	public static final String TARGET_HTTPS_SERVER = "api.twitter.com";
	...
	public static BufferedImage getImage(String userName) throws Exception {
		...
		try {
			...
			out.write("GET /1/users/profile_image/" + userName + "?size=bigger HTTP/1.0\r\n");
