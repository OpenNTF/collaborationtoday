...
public class Type {
	...
	private final List<String> _moderators;
	private final String _displayName;
	private final String _categoryId;
	private String _hashTags;

	public Type(final String iD, final String displayName, final List<String> moderators,
			final String description, final String categoryId, final String hashTags) {
		_iD = iD;
